...
void installPngEncoder(jsi::Runtime& jsiRuntime, const std::string& cachePath) {
    ...
    auto detectFromRgb = jsi::Function::createFromHostFunction(
                                                                  jsiRuntime, // JSI runtime instance
                                                                  jsi::PropNameID::forAscii(jsiRuntime, "__detectFromRgb"), // Internal function name
                                                                  ...
                                                                  [cachePath](jsi::Runtime& runtime, const jsi::Value& thisValue, const jsi::Value* arguments, size_t count) -> jsi::Value {
                                                                      ...
                                                                      if(barcodes.empty()){
                                                                          return jsi::String::createFromUtf8(runtime, "No barcode found");
                                                                      }
                                                                      
                                                                      return jsi::String::createFromUtf8(runtime, "Found a barcode!");
                                                                  }
                                                                  );
...
auto saveRgbAsPngFunc = jsi::Function::createFromHostFunction(
    ...
    jsiRuntime.global().setProperty(jsiRuntime, "__detectFromRgb", std::move(detectFromRgb));
